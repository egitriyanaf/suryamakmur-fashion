			...
			<nav class="navbar navbar-expand-lg navbar-light">
				<div class="container-fluid">
                    <a class="navbar-brand logo_h" href="{{ url('/') }}">
                        <img src="{{asset('assets/img/logo.png')}}" width="100px" height="100px" alt="logo">
                    </a>
		...
		<div class="container">
			...
			<div class="row footer-bottom d-flex justify-content-between align-items-center">
				<p class="col-lg-12 footer-text text-center">
                    ...
                    <i class="fa fa-magic" aria-hidden="true"></i> by <a href="https://egitriyanaf.github.io/My-Portfolio" target="_blank">Egi Triyana Fidollah</a>
				</p>
			</div>
		</div>
	</footer>
